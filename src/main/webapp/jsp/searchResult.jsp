            ...
            success: function (data) {
                if (data) {
                    ...
                    for (var i = begin; i <= end; i++) {
                        var book = books[i - 1];
                        var li = '<li class="subject-item"> <div class="pic"> <a class="nbg" href="/book/findBook?bookId=' + book.bookId + '"> <img src="../' + book.bookImage + '" width="90"> </a> </div> <div class="info"> <h2> <a href="/book/findBook?bookId=' + book.bookId + '">' + book.bookName + '</a>' + book.bookNO + '<span>' + book.bookType + '</span> </h2> <div class="pub">' + book.author + ' /';
